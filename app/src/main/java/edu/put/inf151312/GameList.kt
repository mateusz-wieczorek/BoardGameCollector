...
import edu.put.inf151312.databinding.ActivityGameListBinding
...
class GameList : AppCompatActivity(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var rows = dbHandler.getRowCount()
        var yearFlag=0
        var titleFlag=0
        fun dispGame(tag:Int){
            ...
            explicitIntentDetails.putExtra("EXP", 0)
        ...
        fun sort(option:String){
            ...
            var gamesList=dbHandler.getAllGames()
        ...
        for (rowNumber in 1..rows) {
            ...
            val game: Game? = dbHandler.selectRow(rowNumber)
